...
\begin{figure*}
\includegraphics[width=\textwidth]{figures_tmp/sys/scatter_fwhm.png}
...
\end{tabular}
\caption{\label{fig:sys_correlation} Demonstration of the covariance between the survey properties. The anti-correlation between the Background counts in the coadds and the stellar number density is evident.  } 
\end{figure*}
